...
struct ContentView: View {
    ...
    @State private var isShowingImageClassificationView = false
        ...
        NavigationView() {
            ZStack {
                ...
                .sheet(isPresented: $isShowingCamera) {
                    ImagePicker(image: $image, sourceType: .camera) { capturedImage in
                        isShowingImageClassificationView = true
                        image = capturedImage
                    }
                }
                .sheet(isPresented: $isShowingImageClassificationView) {
                    if let image = image {
                        ImageClassificationView(image: image)
                    }
                }
            }
        }
